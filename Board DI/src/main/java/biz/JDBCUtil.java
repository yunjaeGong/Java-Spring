...
public class JDBCUtil {
    ...
    public static Connection getConnedtion() {
        try {
            ...
            return DriverManager.getConnection("jdbc:mysql://" + server + "/" + database + "?serverTimezone=UTC&useSSL=FALSE&allowPublicKeyRetrieval=true&useUnicode=FALSE&characterEncoding=UTF-8", user_name, password);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
