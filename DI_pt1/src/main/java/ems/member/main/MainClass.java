...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		// xml 대신 Assembler 클래스 이용해서 각 Depencency Injection 수행

		// 생성자에서 dao 객체를 생성하고, 그 객체를 각 서비스의 생성자로 전달(주입)해 하나의 dao 인스턴스 공유
		// 모든 서비스가 map을 사용
		...
		for (int j = 0; j < sNums.length; j++) {
			...
			registerService.register(student); // 학생 map에 등록
		}
