...
import com.word.service.WordRegisterServiceMyAutowired;
import com.word.service.WordSearchService;
import com.word.service.WordSearchServiceMyAutowired;
import org.springframework.context.support.GenericXmlApplicationContext;

public class MainClassMyAutowired {
	...
	public static void main(String[] args) {
		...
		GenericXmlApplicationContext ctx = 
				new GenericXmlApplicationContext("appCtxMyAutowired.xml");
		
		WordRegisterServiceMyAutowired registerService =
				ctx.getBean("registerServiceMyAutowired", WordRegisterServiceMyAutowired.class);
		// 위 DB 등록
		...
		WordSearchServiceMyAutowired searchService =
				ctx.getBean("searchServiceMyAutowired", WordSearchServiceMyAutowired.class);
